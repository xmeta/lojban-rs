...
- **統語論**(コアサブセット)
  ...
  - 抽象(`nu ka ni zu'o …`)/ `ke … kehe` グルーピング
...
| `tests/corpus.rs` | **Tatoeba 実文97文**(CC BY 2.0 FR)+ CLL 風厳選例文46文 |
...
- 引用(`lu … lihu` / `zo` / `zoi` / `lohu … lehu`)は語彙のみ定義済み、統語は未接続
