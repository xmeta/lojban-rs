...
## 現在の状態: v0.83 完成(全テストグリーン)

- ライブラリ20 / 形態論11 / 統語123 / battery 5 / cli 19 / coverage_doc 1 / コーパス3 / doc 10 / fuzz 3(+ignore 2) = 計195テスト全パス
- コーパス 418 文(Tatoeba 実文受理率 94% を維持)
- Cargo.toml の版数を STATUS 版数に同期(0.80.0)
...
- ライブラリ20 / 形態論11 / 統語123 / cli 16 / coverage_doc 1 / コーパス3 / doc 10 / fuzz 3(+ignore 2) = 計187テスト全パス
- コーパス 418 文(Tatoeba 実文受理率 94% を維持)
- Cargo.toml の版数を STATUS 版数に同期(0.77.0)
