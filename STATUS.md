...
## 現在の状態: v0.40 完成(全テストグリーン)

- ライブラリ20 / 形態論11 / 統語116 / コーパス3 / doc 4 / fuzz 3(+ignore 2) = 計157テスト全パス
...
## 次の拡張候補
- CEhE 項リスト区切り(camxes terms_2 準拠。意味論要確認)、
- Tatoeba 再検証の定期実施、coverage.md の自動更新スクリプト化
